...
<div class="container my-3">
  ...
  <br>
  <center><a class="btn btn-white" href="tambah_r.php">
  Add Data</a></center>
  <br>
    <form>
                <section class="text-white">
                  ...
                  <table border="1" style="margin: auto;" width="1000px" height="200px">
                    <thead>
                      <tr style="text-align: center;">
                       <th width="10px">Id_ruangan</th>
                        <th width="100px">Nama_ruangan</th>
                        <th width="100px">Deskripsi_ruangan</th>
                        <th width="100px">Nilai_suhu</th>
                        <th width="100px">Nilai_kelembapan</th>
                 ...
                 <?php
                  $no=0;
                  $result = mysqli_query($koneksi, "SELECT * FROM ruangan ORDER BY Id_ruangan ASC");
                ...
                ?>
                      <tr align="center"> 
                        ...
                        <td><?php echo $row['Deskripsi_ruangan'];?></td>
                        <td><?php echo $row['Nilai_suhu'];?></td>
