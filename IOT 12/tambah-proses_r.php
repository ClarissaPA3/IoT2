...
if (isset($_POST['tambah'])) {
    ...
    $Tanggal = $_POST['Tanggal']
        ...
        $query = "INSERT INTO ruangan (Id_ruangan, Nama_ruangan, Deskrisi_ruangan, Nilai_suhu, Nilai_kelembapan, Tanggal) VALUES('$Id_ruangan', '$Nama_ruangan', '$Deskripsi_ruangan', '$Nilai_suhu' , '$Nilai_kelembapan' , '$Tanggal') ";
